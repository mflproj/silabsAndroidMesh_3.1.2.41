...
enum class Experiment(val maxTime: Long,
    ...
    // 9
    CONTROL_NODE_UUID_0E_0F_WITH_ACK(5000, R.string.test_title_unicast_control, R.string.test_desc_unicast_control_proxy_ack, Node.PROXY),
    CONTROL_NODE_UUID_0E_0F_WITHOUT_ACK(5000, R.string.test_title_unicast_control, R.string.test_desc_unicast_control_proxy_no_ack, Node.PROXY),
    CONTROL_NODE_UUID_0E_1F_WITH_ACK(5000, R.string.test_title_unicast_control, R.string.test_desc_unicast_control_relay_ack, Node.RELAY),
    CONTROL_NODE_UUID_0E_1F_WITHOUT_ACK(5000, R.string.test_title_unicast_control, R.string.test_desc_unicast_control_relay_no_ack, Node.RELAY),
    // 13
    CONTROL_NODE_UUID_0E_2F_WITH_ACK(5000, R.string.test_title_unicast_control, R.string.test_desc_unicast_control_friend_ack, Node.FRIEND),
    CONTROL_NODE_UUID_0E_2F_WITHOUT_ACK(5000, R.string.test_title_unicast_control, R.string.test_desc_unicast_control_friend_no_ack, Node.FRIEND),
    ...
    CONTROL_NODE_UUID_0E_3F_WITHOUT_ACK(5000, R.string.test_title_unicast_control, R.string.test_desc_unicast_control_lpn_no_ack, Node.LPN),
    // 17
    CONTROL_GROUP(5000, R.string.test_title_multicast_control, R.string.test_desc_multicast_control),
